...
exports.updateSettings = exports.login = exports.logOut = exports.checkOut = void 0;
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data, type) {
    var response;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          if (response.data.status === 'success') {
            window.setTimeout(function () {
              (0, _alert.showAlert)('success', 'Settings saved');
            }, 1000);
          }
          _context3.next = 10;
          break;
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          if (response.data.status === 'success') {
            location.assign("".concat(response.data.data.url));
          }
          _context4.next = 10;
          break;
        case 7:
...
if (form) {
  form.addEventListener('submit', function (e) {
    ...
    (0, _helpers.login)(email, password);
  });
}
if (logOutBtn) {
  logOutBtn.addEventListener('click', _helpers.logOut);
}
...
if (saveForm) {
  saveForm.addEventListener('submit', function (e) {
    ...
    (0, _helpers.updateSettings)(form, 'updateme');
  });
}
...
// booking
var bookTourButton = document.getElementById("bookTour");
if (bookTourButton) {
  bookTourButton.addEventListener('click', function () {
    bookTourButton.textContent = "Processing...";
    (0, _helpers.checkOut)(bookTourButton.dataset.tourid);
  });
}
